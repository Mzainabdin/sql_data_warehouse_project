...
This Project demonstrates a comporehensive data warehousing and analytics solution, from building a data warehouse to generating actionable insights. Designed as a portfolio project

## Data Architecture
Data Architecture for this project follow the **medallion Architecture** bronze, silver and gold layer:
![Data Architecture](docs/data_architecture.png)

1. **Bronze Layer:** Store raw data as it is from the source systems. Data is ingested from csv files and than validated.
2. **Silver Layer:** The layer include data cleansing, standardization, and normalization processes to prepare data for analysis.
3. **Gold Layer:** It involve, creating facts and dimension views modeled in a star schema view.
...
Hi there! I'm **Muhammad Zain Ul Abdin**, also known as **Zain**. I’m passionate about data and keen on learning  and sharing knowledge and working with data.

Let's stay in touch! Feel free to connect with me on the following platforms:

[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/muhammad-zain-ul-abdin-a63712195?utm_source=share_via&utm_content=profile&utm_medium=member_android)
